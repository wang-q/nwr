...
* `formats` - File formats documentation
...
* Text files (formats, abbr) are written as plain text.
...
1. Print file formats documentation
   `nwr kb formats`

2. Save abbreviated names script
   `nwr kb abbr -o abbr.pl`

3. Extract bacterial marker genes
   `nwr kb bac120 -o marker_genes/`

4. Extract archaeal marker genes
