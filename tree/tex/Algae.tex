...
[, tier=5,
  [, tier=4,
    [, dot, label={Eukaryota}, tier=3,
      [, dot, label={Sar}, tier=2,
        [, dot, label={Alveolata}, tier=1,
          [{Dinophyceae}, comment={2864 class}, tier=0,]
          [{Apicomplexa}, comment={5794 phylum}, tier=0,]
          [{Ciliophora}, comment={5878 phylum}, tier=0,]
        ]
        [, dot, label={Ochrophyta}, tier=1,
          [{Chrysophyceae}, comment={2825 class}, tier=0,]
          [{Bacillariophyta}, comment={2836 phylum}, tier=0,]
          [{Phaeophyceae}, comment={2870 class}, tier=0,]
        ]
      ]
      [{Cryptophyceae}, comment={3027 class}, tier=0,]
      [{Rhodophyta}, comment={2763 phylum}, tier=0,]
      [, dot, label={Euglenozoa}, tier=1,
        [{Euglenida}, comment={3035 class}, tier=0,]
        [{Kinetoplastea}, comment={5653 class}, tier=0,]
      ]
      [{Haptophyta}, comment={2830 phylum}, tier=0,]
      [{Chlorophyta}, comment={3041 phylum}, tier=0,]
    ]
    [{Cyanobacteriota}, comment={1117 phylum}, tier=0,]
  ]
]
%FOREST_END%
\end{forest}
